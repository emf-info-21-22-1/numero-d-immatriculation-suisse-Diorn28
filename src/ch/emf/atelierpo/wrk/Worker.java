...
public class Worker {
    ...
    * Pour que la méthode fonctionne il va falloir vérifier que le nom du canton soit valide à l'aide d'un IF et que le String pour le numéro de plaque est belle et bien comp
